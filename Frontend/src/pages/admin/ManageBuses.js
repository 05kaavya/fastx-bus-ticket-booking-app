  ...
  return (
    <Container className="mt-4">
      <Row className="mb-4">
        <Col>
          <h2>Manage Buses</h2>
          <p className="text-muted">Admin can view and delete buses only</p>
        </Col>
      </Row>
                  ...
                  <tbody>
                    {buses.map((bus) => (
                      <tr key={bus.busId}>
                        ...
                        <td>{bus.operator?.operatorName || 'N/A'}</td>
                        <td>
                          <Button 
      ...
      <Modal show={showDeleteModal} onHide={() => setShowDeleteModal(false)}>
        ...
        <Modal.Body>
          {busToDelete && (
            <div>
              ...
              <p><strong>Bus Name:</strong> {busToDelete.busName}</p>
              <p><strong>Bus Number:</strong> {busToDelete.busNumber}</p>
              <p className="text-danger">
                <strong>Warning:</strong> This action cannot be undone. Deleting this bus may affect existing routes and schedules.
              </p>
            </div>
          )}
        </Modal.Body>
        <Modal.Footer>
          ...
          <Button 
            variant="danger" 
            onClick={() => handleDelete(busToDelete?.busId)}
          >
            Delete Bus
          </Button>
        </Modal.Footer>
